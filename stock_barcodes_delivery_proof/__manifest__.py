...
# License AGPL-3.0 or later (http://www.gnu.org/licenses/agpl.html).
{
    ...
    "summary": "Capture delivery proof photos from barcode scanner interface",
    "version": "17.0.1.0.0",
    ...
    "assets": {
        "web.assets_backend": [
            "stock_barcodes_delivery_proof/static/src/components/**/*.js",
            "stock_barcodes_delivery_proof/static/src/components/**/*.xml",
            "stock_barcodes_delivery_proof/static/src/components/**/*.scss",
            "stock_barcodes_delivery_proof/static/src/widgets/**/*.js",
            "stock_barcodes_delivery_proof/static/src/widgets/**/*.xml",
